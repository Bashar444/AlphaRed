-- PrimoData Analytics — Database Import (with rise_ prefix)
...
CREATE TABLE IF NOT EXISTS `rise_primo_surveys` (
...
CREATE TABLE IF NOT EXISTS `rise_primo_questions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rise_primo_targeting_presets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_respondents` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_respondent_otp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rise_primo_responses` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `survey_id` int(11) NOT NULL,
  `respondent_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_answers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `rise_primo_analysis_reports` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `survey_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_exports` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `survey_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_public_datasets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_api_keys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_usage_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rise_primo_subscriptions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
